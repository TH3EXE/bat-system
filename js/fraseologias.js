// js/fraseologias.js
// Este arquivo contém APENAS os dados de texto.
// A lógica que usa isso está em 'app.js'.
// 'campos' define quais inputs <input> serão criados dinamicamente.

const DADOS_RESTRICOES = {
    '01': {
...
`,
        'campos': ['{procedimento}', '{data_disponivel}']
    },
    '02': {
...
`,
        'campos': ['{procedimento01}', '{procedimento02}']
    },
    '08': {
...
EM CASO DE DÚVIDAS, POR FAVOR, ENTRE EM CONTATO COM A CENTRAL DE ATENDIMENTO PELOS TELEFONES: 4090-1740, 0800 409 1740 OU 0800 463 4648.
`,
        'campos': ['{cidade_estado}', '{procedimento}']
    },
    '24': {
...
EM CASO DE DÚVIDAS, POR FAVOR, ENTRE EM CONTATO COM A CENTRAL DE ATENDIMENTO PELOS TELEFONES: 4090-1740, 0800 409 1740 OU 0800 463 4648.
`,
        'campos': ['{procedimento}', '{nome_plano}']
    },
    '48': {
...
EM CASO DE DÚVIDAS, POR FAVOR, ENTRE EM CONTATO COM A CENTRAL DE ATENDIMENTO PELOS TELEFONES: 4090-1740, 0800 409 1740 OU 0800 463 4648.
`,
        'campos': ['{procedimento}', '{senha}', '{prestador}']
    },
    'FALTA_DOCUMENTACAO': {
...
// ===============================================
// ATUALIZAÇÃO - NOVA ESTRUTURA PARA 'POSITIVAS'
// ===============================================
const FRASEOLOGIA_POSITIVA = {
    'nome': 'Autorização Padrão (Múltipla)',
    // O texto foi dividido em 3 partes
    'header': `
PREZADO(A) SR(A). [_NM_BENEFICIARIO_],
NÚMERO DO PROTOCOLO: [_NU_PROTOCOLO_]
...
`,
    // Este 'template' será usado para cada procedimento
    'body_template': `
PROCEDIMENTO: {procedimento}
SENHA: {senha}
PRESTADOR: {prestador}
...
EM CASO DE DÚVIDAS, POR FAVOR, ENTRE EM CONTATO COM A CENTRAL DE ATENDIMENTO PELOS TELEFONES: 4090-1740, 0800 409 1740 OU 0800 463 4648.
`,
    // 'campos' está vazio porque a lógica agora é customizada no app.js
    'campos': []
};